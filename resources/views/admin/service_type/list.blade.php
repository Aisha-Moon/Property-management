        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">
                            <a href="{{ url('admin/service_type/add') }}" class="btn btn-primary">Add Service Type</a>
                        </h5>
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                   ...
                                   <td>
                                    ...
                                    <a onclick="return confirm('Are You Sure Want To Delete?')" href="{{ url('admin/service_type/delete/'.$value->id) }}" class="btn btn-danger"><i class="bi bi-trash"></i></a>
