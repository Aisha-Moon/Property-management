                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <a href="{{ url('admin/user/list') }}" class="btn btn-success" style="margin-top: 30px;">Reset</a>
                                </div>
                            </div>
                        </div>
                    </form>
                            ...
                            <tbody>
                                ...
                                <td>
                                   ...
                                   <td>
                                    ...
                                    <a onclick="return confirm('Are You Sure Want To Delete?')" href="{{ url('admin/user/delete/'.$value->id) }}" class="btn btn-danger">Delete</a>
                                   </td>
                                </tr>
